...
VIEW_FILE_PATH="\${SRCROOT}/CardApp/Modules/${MODULE_NAME}/${MODULE_NAME}View.swift"
INTERACTOR_FILE_PATH="\${SRCROOT}/CardApp/Modules/${MODULE_NAME}/${MODULE_NAME}Interactor.swift"
ROUTER_FILE_PATH="\${SRCROOT}/CardApp/Modules/${MODULE_NAME}/${MODULE_NAME}Router.swift"
...
APP_ASSEMBLY_FILE_PATH="CardApp/Modules/App/AppAssembly/DependencyManager.swift"
...
# Sort project file
python Scripts/xUnique.py -scpv "CardApp.xcodeproj/project.pbxproj"
